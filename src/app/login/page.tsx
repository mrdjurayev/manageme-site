...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f3f4f6] px-4 py-8">
      <section className="w-4/5 rounded-2xl border border-[#e5e7eb] bg-white px-7 py-12 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05),0_2px_4px_-1px_rgba(0,0,0,0.03)] sm:w-4/5 sm:px-10 sm:py-14 md:w-2/3 md:max-w-[520px] lg:w-1/3 lg:min-w-[430px] lg:max-w-[470px]">
